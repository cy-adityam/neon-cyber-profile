        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <div className="relative">
              <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-2 border-cyber-neon/50 p-1">
          ...
          {/* Text Content */}
          <div className="w-full md:w-3/5 text-center md:text-left md:pl-10">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-2 font-orbitron">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyber-blue to-cyber-neon">
                JOHN DOE
              </span>
            </h1>
            
            <h2 className="text-xl md:text-2xl font-medium mb-6 text-cyber-silver">
              I am a{" "}
              <TypingEffect 
                texts={roles} 
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <Button 
                className="w-48 bg-cyber-blue hover:bg-cyber-neon text-white font-medium py-2 px-6 rounded-full cyber-glow"
              ...
              <Button 
                variant="outline" 
                className="w-48 border-cyber-silver/50 hover:border-cyber-neon hover:text-cyber-neon"
                onClick={() => {
